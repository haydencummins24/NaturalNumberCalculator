...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        //disable divide and root
        boolean root = false;
        boolean divide = false;
        this.bRoot.setEnabled(root);
        this.bDivide.setEnabled(divide);
        ...
        //should I add this.tTop & this.tBottom within new JScrollPane
